...
class PrintedTextRecognizer:
    ...
    # Your uploaded pages are around 1275x1650.
    # There is no benefit in resizing them further.
    MAX_DIMENSION = 1800

    # EasyOCR's internal detection canvas.
    #
    # 2048 is unnecessarily large for 1275x1650 pages.
    # 1600 gives a useful speed improvement while preserving
    # enough resolution for normal printed documents.
    OCR_CANVAS_SIZE = 1400
